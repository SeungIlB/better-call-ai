...
public enum ErrorCode {
    ...
    ANALYSIS_KEY_CONFLICT(HttpStatus.CONFLICT, "ANALYSIS_002", "같은 요청 키에 다른 분석 입력을 사용할 수 없습니다."),
    ANALYSIS_BUSY(HttpStatus.CONFLICT, "ANALYSIS_003", "이 사건의 분석이 진행 중입니다."),
    ANALYSIS_FAILED(HttpStatus.SERVICE_UNAVAILABLE, "ANALYSIS_004", "분석을 완료하지 못했습니다. 기록을 확인한 뒤 새 요청으로 시도해 주세요."),
    ...
    LEGAL_ANSWER_FAILED(HttpStatus.SERVICE_UNAVAILABLE, "LEGAL_ANSWER_001", "근거를 확인할 수 있는 안내 초안을 만들지 못했습니다."),
    LEGAL_ANSWER_BUSY(HttpStatus.TOO_MANY_REQUESTS, "LEGAL_ANSWER_002", "안내 초안 요청이 많습니다. 잠시 후 다시 시도해 주세요."),
    INTEGRATION_NOT_CONFIGURED(HttpStatus.SERVICE_UNAVAILABLE, "COMMON_002", "외부 연동 설정이 필요합니다."),
    PAYMENT_ORDER_NOT_FOUND(HttpStatus.NOT_FOUND, "BILLING_001", "결제 주문을 찾을 수 없습니다."),
    PAYMENT_AMOUNT_MISMATCH(HttpStatus.CONFLICT, "BILLING_002", "결제 금액이 주문과 일치하지 않습니다."),
    PAYMENT_ALREADY_PROCESSED(HttpStatus.CONFLICT, "BILLING_003", "이미 처리된 결제 주문입니다."),
    PAYMENT_FAILED(HttpStatus.BAD_GATEWAY, "BILLING_004", "결제 승인을 완료하지 못했습니다."),
